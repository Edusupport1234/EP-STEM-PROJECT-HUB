...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, onClick, onToggleLike }) => {
  ...
  return (
    <div 
      className="bg-white rounded-[2.5rem] shadow-2xl border-none overflow-hidden hover:shadow-[0_40px_80px_rgba(0,0,0,0.3)] transition-all group cursor-pointer flex flex-col h-full transform hover:-translate-y-2 relative"
